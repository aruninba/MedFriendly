...
public class CircleProgress extends View {
    ...
    public int default_finished_color = Color.rgb(66, 145, 241);
    ...
    public CircleProgress(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        attributes = context.getTheme().obtainStyledAttributes(attrs, R.styleable.CircleProgress, defStyleAttr, 0);
